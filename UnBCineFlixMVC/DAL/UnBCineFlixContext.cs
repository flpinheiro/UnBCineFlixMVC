...
namespace UnBCineFlix.DAL
{
    ...
    : base(option)
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AddressCompany>().HasOne(a => a.Company).WithMany(c => c.Addresses).OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity<Address>().HasData(
                ...
                new Address { Id = 2, City = "brasilia", District = "Asa norte", Street = "Campus Darcy Ribeiro", Number = 0, Complement = "ICC Norte", Country = "Brasil", State = "DF", ZipCode = 70000000 }
            );
